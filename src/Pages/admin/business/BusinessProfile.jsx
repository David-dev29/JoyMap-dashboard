  ...
  useEffect(() => {
    const loadBusinessData = async () => {
      ...
      try {
        ...
        // Load bank info
        if (business.bankInfo) {
          setBankInfo({
            bankName: business.bankInfo.bankName || '',
            accountNumber: business.bankInfo.accountNumber || '',
            clabe: business.bankInfo.clabe || '',
            accountHolder: business.bankInfo.accountHolder || '',
          });
        }
          ...
          <MobileSection id="payments" title="Métodos de Pago" icon={CreditCard}>
            <div className="space-y-3">
              ...
              {paymentMethods.transfer && (
                <div className="mt-2 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl space-y-3">
